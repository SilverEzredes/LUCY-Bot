...
class Levelling(commands.Cog,
    ...
    async def stats(self, ctx, user: discord.Member = None):
        ...
        utils.draw_text    (draw, globals.font47, f"{level[0]}", "#232323", (335, 120,), 999)
        if user.id == globals.ADMIN_ID:
            utils.draw_text(draw, globals.font47, f"{cred[0]}",  "#232323", (480, 120,), 999)
        else:
            utils.draw_text(draw, globals.font47, f"{cred[0]}",  "#232323", (480, 120,), 999)
        # Draw trophy shards
        x = 267
        ...
        if user.id == globals.ADMIN_ID:
            ...
            utils.draw_text(draw, globals.font47, f"{level[0]}",      "#9c3103", (515, 340,), 999)
        else:
